...
docker run -it --rm -p 1338:80 sample:prod
docker tag sample:prod reactazuredockeracr.azurecr.io/samples/react-azure-docker-img
...
az webapp create --name react-azure-docker-wa --resource-group react-azure-docker-rg --plan react-azure-docker-sp
az webapp config container set 
        --docker-custom-image-name tetefufu/myapp:latest
        --plan $p
        --resource-group $g
...
az group create --location eastus --name react-azure-docker-rge
az appservice plan create --name react-azure-docker-spe --resource-group react-azure-docker-rge
az webapp create --name react-azure-docker-wae --resource-group react-azure-docker-rge --plan react-azure-docker-spe --deployment-container-image-name reactazuredockeracr.azurecr.io/samples/react-azure-docker-img:latest
az webapp identity assign --resource-group react-azure-docker-rge --name react-azure-docker-wae --query principalId --output tsv
az account show
...
az webapp config container set --name react-azure-docker-wae --resource-group react-azure-docker-rge --docker-custom-image-name reactazuredockeracr.azurecr.io/samples/react-azure-docker-img:latest --docker-registry-server-url https://reactazuredockeracr.azurecr.io
